		...
		Steps: []resource.TestStep{
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(testEMgSourceId, "settings.mongo_source.connection.on_premise.port", "27015"),
					...
					resource.TestCheckResourceAttr(testEMgTargetId, "settings.mongo_target.connection.on_premise.port", "27015"),

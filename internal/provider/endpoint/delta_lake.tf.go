...
// source: cloud/doublecloud/public-api/doublecloud/transfer/v1/endpoint/delta_lake.proto
...
// DeltaResultTable_TF struct with tfsdk field DeltaResultTable DeltaLakeSource.table
type DeltaResultTable_TF struct {
	active types.Bool `tfsdk:"active",json:"active"`
}

func GenTFSchemaDeltaResultTable() schema.SingleNestedBlock {
	return schema.SingleNestedBlock{Attributes: map[string]schema.Attribute{"active": schema.BoolAttribute{
		Description: "Automatically generated field preventing empty message errors",
		Optional:    true,
	}}}
...
// DeltaSettings_TF struct with tfsdk field DeltaSettings DeltaLakeSource.settings
type DeltaSettings_TF struct {
	Region types.String `tfsdk:"region",json:"region"`
}

func GenTFSchemaDeltaSettings() schema.SingleNestedBlock {
	return schema.SingleNestedBlock{Attributes: map[string]schema.Attribute{"region": schema.StringAttribute{
		Description: "",
		Optional:    true,
	}}}
}

// DeltaLakeSource_TF struct with tfsdk field DeltaLakeSource DeltaLakeSource
type DeltaLakeSource_TF struct {
	Provider *Provider_TF         `tfsdk:"provider",json:"provider"`
	Table    *DeltaResultTable_TF `tfsdk:"table",json:"table"`
	Settings *DeltaSettings_TF    `tfsdk:"settings",json:"settings"`
}

func GenTFSchemaDeltaLakeSource() schema.SingleNestedBlock {
	return schema.SingleNestedBlock{Attributes: map[string]schema.Attribute{
		"provider": schema.SingleNestedAttribute{
			Attributes:  GenTFSchemaProvider().Attributes,
			Description: "",
		...
		"settings": schema.SingleNestedAttribute{
			Attributes:  GenTFSchemaDeltaSettings().Attributes,
			Description: "",
			Optional:    true,
		},
		"table": schema.SingleNestedAttribute{
			Attributes:  GenTFSchemaDeltaResultTable().Attributes,
			Description: "",
			Optional:    true,
		},
	}}

		...
		Steps: []resource.TestStep{
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.doublecloud_clickhouse.test", "connection_info.https_port_ctls", "0"),
					resource.TestCheckResourceAttr("data.doublecloud_clickhouse.test", "connection_info.tcp_port_secure_ctls", "0"),
					resource.TestCheckResourceAttr("data.doublecloud_clickhouse.test", "private_connection_info.https_port_ctls", "0"),
					resource.TestCheckResourceAttr("data.doublecloud_clickhouse.test", "private_connection_info.tcp_port_secure_ctls", "0"),
				),
			},
		},
	})
